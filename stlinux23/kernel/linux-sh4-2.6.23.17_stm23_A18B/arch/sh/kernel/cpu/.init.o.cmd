cmd_arch/sh/kernel/cpu/init.o := sh4-linux-gcc -Wp,-MD,arch/sh/kernel/cpu/.init.o.d  -nostdinc -isystem /opt/STM/STLinux-2.4/devkit/sh4/lib/gcc/sh4-linux/4.7.2/include -D__KERNEL__ -Iinclude  -include include/linux/autoconf.h -Wall -Wundef -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -Werror-implicit-function-declaration -O2 -pipe -m4 -m4-nofpu -m4-300 -m4-300-nofpu -ml -Wa,-isa=st40-300-up -ffreestanding -fomit-frame-pointer -g  -fno-stack-protector -Wdeclaration-after-statement -Wno-pointer-sign    -D"KBUILD_STR(s)=\#s" -D"KBUILD_BASENAME=KBUILD_STR(init)"  -D"KBUILD_MODNAME=KBUILD_STR(init)" -c -o arch/sh/kernel/cpu/init.o arch/sh/kernel/cpu/init.c

deps_arch/sh/kernel/cpu/init.o := \
  arch/sh/kernel/cpu/init.c \
    $(wildcard include/config/speculative/execution.h) \
    $(wildcard include/config/cache/writethrough.h) \
    $(wildcard include/config/cache/writeback.h) \
  ...
  include/asm/ubc.h \
    $(wildcard include/config/cpu/subtype/sh7707.h) \
    $(wildcard include/config/cpu/subtype/sh7709.h) \
    $(wildcard include/config/ubc/wakeup.h) \
  include/asm/cpu/ubc.h \
  include/asm/smp.h \

arch/sh/kernel/cpu/init.o: $(deps_arch/sh/kernel/cpu/init.o)
