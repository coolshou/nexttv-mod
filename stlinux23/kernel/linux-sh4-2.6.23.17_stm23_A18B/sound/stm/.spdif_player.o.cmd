cmd_sound/stm/spdif_player.o := sh4-linux-gcc -Wp,-MD,sound/stm/.spdif_player.o.d  -nostdinc -isystem /opt/STM/STLinux-2.4/devkit/sh4/lib/gcc/sh4-linux/4.7.2/include -D__KERNEL__ -Iinclude  -include include/linux/autoconf.h -Wall -Wundef -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -Werror-implicit-function-declaration -O2 -pipe -m4 -m4-nofpu -m4-300 -m4-300-nofpu -ml -Wa,-isa=st40-300-up -ffreestanding -fomit-frame-pointer -g  -fno-stack-protector -Wdeclaration-after-statement -Wno-pointer-sign    -D"KBUILD_STR(s)=\#s" -D"KBUILD_BASENAME=KBUILD_STR(spdif_player)"  -D"KBUILD_MODNAME=KBUILD_STR(snd_stm)" -c -o sound/stm/spdif_player.o sound/stm/spdif_player.c

deps_sound/stm/spdif_player.o := \
  sound/stm/spdif_player.c \
    $(wildcard include/config/write.h) \
    $(wildcard include/config/opcode/4.h) \
    $(wildcard include/config//dma/req/trig/lmt.h) \
  ...
  sound/stm/common.h \
    $(wildcard include/config/snd/stm/debug/level.h) \
  ...
  sound/stm/reg_aud_spdif.h \
    $(wildcard include/config//p/bit.h) \
    $(wildcard include/config//p/bit//mask.h) \
    $(wildcard include/config//p/bit//hw.h) \
    $(wildcard include/config//p/bit//fdma.h) \
    $(wildcard include/config//c/bit.h) \
    $(wildcard include/config//c/bit//mask.h) \
    $(wildcard include/config//c/bit//fdma.h) \
    $(wildcard include/config//c/bit//hw.h) \
    $(wildcard include/config//u/bit.h) \
    $(wildcard include/config//u/bit//mask.h) \
    $(wildcard include/config//u/bit//fdma.h) \
    $(wildcard include/config//u/bit//hw.h) \
    $(wildcard include/config//v/bit.h) \
    $(wildcard include/config//v/bit//mask.h) \
    $(wildcard include/config//v/bit//fdma.h) \
    $(wildcard include/config//v/bit//hw.h) \
    $(wildcard include/config//one/bit/audio.h) \
    $(wildcard include/config//one/bit/audio//disabled.h) \
    $(wildcard include/config//one/bit/audio//enabled.h) \
    $(wildcard include/config//mem/fmt.h) \
    $(wildcard include/config//mem/fmt//16/bits/0/bits.h) \
    $(wildcard include/config//mem/fmt//16/bits/16/bits.h) \
    $(wildcard include/config//dts/hd.h) \
    $(wildcard include/config//dts/hd//disabled.h) \
    $(wildcard include/config//dts/hd//enabled.h) \
    $(wildcard include/config//back/stalling.h) \
    $(wildcard include/config//back/stalling//disabled.h) \
    $(wildcard include/config//back/stalling//enabled.h) \

sound/stm/spdif_player.o: $(deps_sound/stm/spdif_player.o)
